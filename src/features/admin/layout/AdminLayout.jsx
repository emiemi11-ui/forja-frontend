...
import { LayoutDashboard, Users, Inbox, Settings, ShieldCheck, LogOut, UserCircle, Gem } from 'lucide-react';
...
const NAV = [
  ...
  { to: '/admin/upgrades', label: 'Cereri upgrade', Icon: Gem },
  { section: 'Moderare' },
